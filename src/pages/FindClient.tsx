      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          <div className="text-center space-y-4">
            <h1 className="text-4xl font-bold text-white">Find Your Client</h1>
          ...
          <div className="space-y-8 bg-white/10 backdrop-blur-xl rounded-2xl p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-semibold text-white">Skills You Offer</h2>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-semibold text-white">Your Qualities</h2>
              </div>
